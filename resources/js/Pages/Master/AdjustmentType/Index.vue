            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase text-gray-500">COA</th>
                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase text-gray-500">Status</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    <tr v-if="loading">
                        <td colspan="4" class="px-4 py-8 text-center text-sm text-gray-500">Memuat...</td>
                    </tr>
                    <tr v-else-if="rows.length === 0">
                        <td colspan="4" class="px-4 py-8 text-center text-sm text-gray-500">Tidak ada data</td>
                    </tr>
                    <tr
                        v-for="row in rows"
                        v-else
                    ...
                    >
                        ...
                        <td class="px-4 py-2.5 text-sm text-gray-500">{{ row.coa?.code }} {{ row.coa?.name }}</td>
