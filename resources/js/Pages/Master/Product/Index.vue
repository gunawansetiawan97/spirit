...
const {
    ...
    columns: [
        ...
        { key: 'category.name', label: 'Kategori', width: '150px' },
        { key: 'brand.name', label: 'Merk', width: '150px' },
        { key: 'type', label: 'Tipe', width: '100px', align: 'center' },
    ...
    permissionPrefix: 'master.product.product',
}, emit);
</script>
